...
export default function EmergencyBanner({ bannerText, actionText, onAction }: EmergencyBannerProps) {
  return (
    <div className="w-full bg-gradient-to-r from-red-600 via-rose-600 to-red-700 text-white text-xs sm:text-sm py-3 px-4 shadow-md sticky top-0 z-40 flex flex-col md:flex-row items-center justify-between gap-4">
      <div className="flex flex-col md:flex-row items-center gap-2 max-w-4xl mx-auto flex-1 justify-center sm:justify-start">
